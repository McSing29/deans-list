                        ...
                        <div class="tab-pane show active" id="pending">
                            ...
                            <div class="applicant-table-div">
                                <table class="table" id="pendingTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td scope="row" class="align-middle">Natsuki Subaru</td>
                                            <td class="align-middle">1st Year</td>
                                            <td class="align-middle">BSCS</td>
                                            <td class="align-middle">Section A</td>
                                            <td class="align-middle">1.5</td>
                                            <td class="align-middle">subaruxemilia@wmsu.edu.ph</td>
                                            <td class="align-middle"><button type="button" class="btn btn-success accept" data-bs-toggle="modal" data-bs-target="#confirmModal">Accept</button> <button type="button" class="btn btn-danger decline">Decline</button></td>
                                        </tr>
                                        <tr>
                                            <td scope="row" class="align-middle">Nana Komatsu</td>
                                            <td class="align-middle">2nd Year</td>
                                            <td class="align-middle">BSIT</td>
                                            <td class="align-middle">Section C</td>
                                            <td class="align-middle">1.5</td>
                                            <td class="align-middle">nanana@wmsu.edu.ph</td>
                                            <td class="align-middle"><button type="button" class="btn btn-success accept" data-bs-toggle="modal" data-bs-target="#confirmModal">Accept</button> <button type="button" class="btn btn-danger decline">Decline</button></td>
                                        </tr>
                                        <tr>
                                            <td scope="row" class="align-middle">Nana Komatsu</td>
