<?php
    ...
    */
    ...
    if(isset($_POST['save'])){
        ...
        $listers->firstname = htmlentities($_POST['firstname']);
        $listers->lastname = htmlentities($_POST['lastname']);
        $listers->GPA = $_POST['GPA'];
...
<head>
    ...
    <title>Add Dean's List | Dean's List Application System - CCS</title>
    ...
    <div class="home-content">
        <div class="table-container">
            ...
            <div class="add-form-container">
                <form class="add-form" action="editlisters.php" method="post">
                    <input type="text" hidden name="listers-id" value="<?php echo $listers->id; ?>">
                   ...
                   <label for="GPA">GPA</label>
                    <input type="text" id="GPA" name="GPA" required placeholder="Enter GPA" value="<?php if(isset($_POST['GPA'])) { echo $_POST['GPA']; } ?>">
                    <?php
                    ...
                    <input type="department" id="department" name="department" required placeholder="Enter department" value="<?php if(isset($_POST['department'])) { echo $_POST['department']; } ?>">
                    <?php
                    ...
                    <input type="year_level" id="year_level" name="year_level" required placeholder="Enter year_level" value="<?php if(isset($_POST['year_level'])) { echo $_POST['year_level']; } ?>">
                    <?php
                    ...
                    ?>
                    <input type="submit" class="button" value="Save Dean's List" name="save" id="save">
                </form>
            </div>
        </div>
    </div>
