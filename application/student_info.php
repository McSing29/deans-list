<div id='personal-info' class="col-12 col-md-11 profile-screen mt-0 mt-md-3 mx-auto">
    <div class="mt-3 mt-md-0">
        ...
        <div class="card-profile p-4 mt-3">
            <div class="row">
                <h2 class="col-12 fw-bold mb-3">Personal Information</h2>
                <form class="needs-validation" action="" method="post" name="personal-info" id="personal-info">
                    <div class="row g-3">
                        ...
                        <h2 class="col-12 fw-bold my-4 mb-1">Academics</h2>
                        <br>
                        </br>

                        <div class="col-12 col-md-6">
                            <label for="schoolyear" class="form-label">School Year<span class="text-muted"></span></label>
                            <select type="text" class="form-control" id="schoolyear" placeholder="" name="schoolyear" required="">
                                <option value="none">--Select--</option>
                                <?php
                                    require_once '../class/reference.class.php';
                                    $ref_obj = new Reference();
                                    $ref = $ref_obj->get_schoolyear();
                                    foreach($ref as $row){
                                ?>
                                        <option value="<?=$row['schoolyearCode']?>"><?=$row['schoolyearDesc']?></option>
                                <?php
                                    }
                                ?>
                            </select>
                        ...
                        <div class="col-12 col-md-6">
                            <label for="region" class="form-label">Semester<span class="text-muted"></span></label>
                        ...
                        <div class="col-12 col-md-6">
                            <label for="province" class="form-label">Curriculum<span class="text-muted"></span></label>
                            <select type="text" class="form-control" id="province" placeholder="" name="province" required="">
                                <option value="none">--Select--</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-6">
                            <label for="city" class="form-label">Year level<span class="text-muted"></span></label>
                            <select type="text" class="form-control" id="city" placeholder="" name="city" required="">
                                <option value="none">--Select--</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-6">
                            <label for="barangay" class="form-label">Subjects<span class="text-muted"></span></label>
                        ...
                        <div class="col-6 text-end m-0">
                            <button class="btn btn-lg btn-success background-color-green w-100 next-button btn-font m-0" type="submit" value="Next" name="personal" id="personal">
                                Next <i class='bx bxs-right-arrow-square' ></i>
                            </button>
                        </div>
                    </div>
                </form>
